class CollegesController < ApplicationController
  ...
  private
    ...
    def college_params
      params.require(:college).permit(:name, :established, :type, :location, :campus, :noofstudent, :website, :coursesoffered, :scholarshipcourses, :description, :studentaccomodation, :faculty)
    end
end
